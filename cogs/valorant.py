...
class ValorantCog(commands.Cog, name='Valorant'):
    ...
    @app_commands.command(name="파티생성", description='View your player profile')
    @app_commands.guild_only()
    ...
    @app_commands.command(name="파티참여", description='내전에 참여합니다.')
    ...
    @app_commands.command(name="채널분배", description='내전 음성 채널을 나눕니다.')
    @app_commands.guild_only()
    ...
    @app_commands.command(name="채널모집", description='내전 음성 채팅을 다시 모입니다.')
    @app_commands.guild_only()
